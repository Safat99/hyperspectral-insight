...
def tune_conv3d_optuna(
    ...
    print(f"\n=== Optuna tuning | Conv3D-Full | Dataset={dataset_name} ===")
    ...
    # ---------- Patch / stride map (keep same for fair comparison) ----------
    PATCH_STRIDE_MAP = {
        "p5_s1": (5, 1),
        "p9_s1": (9, 1),
        "p13_s1": (13, 1),
    ...
    study_name = f"conv3dfull_{dataset_name}"

    seed = 2000 + int(os.environ.get("SLURM_ARRAY_TASK_ID", 0))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_dir", type=str, default="results/conv3d_full/new/optuna")
